...
const Image: FC<ImgHTMLAttributes<HTMLImageElement> & { src: string }> = ({ src, alt = "", ...props }) => (
...
const UserMessage: FC = () => {
  return (
    <MessagePrimitive.Root
      ...
      data-role="user"
      className="fade-in slide-in-from-bottom-1 animate-in mx-auto grid w-full max-w-(--thread-max-width) auto-rows-auto grid-cols-[minmax(72px,1fr)_auto] content-start gap-y-2 px-2 duration-150 [&>*]:col-start-2"
    >
      <UserMessageAttachments />
