...
const allowedLocalDataAttrs = new Set([
  "data-action",
  "data-allow-native-drag",
  "data-codex-archive-button",
  "data-codex-composer",
  "data-codex-composer-surface",
  "data-codex-empty",
  "data-codex-focus-turn",
  "data-codex-intelligence-trigger",
  "data-codex-node-id",
  "data-codex-api-error",
  "data-codex-os",
...
const allowedLocalSelectors = [
  ...
  ".codex-composer-footer",
  ".codex-composer-send-button",
  ".codex-composer-send-button.codex-send-disabled",
  ".codex-composer-send-button.codex-send-ready",
  ".codex-composer-shell",
  ".codex-composer-surface",
  ".codex-history-page-loader",
  ".codex-home-composer",
  ...
  ".codex-sidebar-content",
  ".codex-session-status-spinner",
  ".codex-session-status-spinner::after",
  ".codex-session-status-spinner::before",
  ".codex-thread-body",
  ".codex-thread-content",
  ".codex-thread-content-shell",
  ".codex-thread-footer-content",
  ...
  ".codex-thread-scroll",
  ".codex-thread-scroll-region",
  ".codex-turn-activity-icon-spacer",
  ".codex-turn-activity-status",
  "#codexPanel",
];
